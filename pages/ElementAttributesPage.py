...
class ElementAttributesPage(BasePage):
    ...
    def check_custom_attr_in_p1(self):
        ...
        assert (expected_attr_val in actual_attr_val), \
            f"{ErrorEnums.ATTRIBUTE_NOT_EQUAL.value} ({expected_attr_val} : {actual_attr_val})"
    ...
    def first_check_dynamic_attrs_p2(self):
        ...
        assert (expected_attr1_val in actual_attr1_val), \
            f"{ErrorEnums.ATTRIBUTE_NOT_EQUAL.value} ({expected_attr1_val} : {actual_attr1_val})"

        assert (expected_attr2_val == actual_attr2_val), \
            f"{ErrorEnums.ATTRIBUTE_NOT_EQUAL.value} ({expected_attr2_val} : {actual_attr2_val})"
    ...
    def second_check_dynamic_attrs_p2(self):
        ...
        assert (expected_1 in actual_1), \
            f"{ErrorEnums.ATTRIBUTE_NOT_EQUAL.value} ({expected_1} : {actual_1})"

        assert (expected_2 == actual_2), \
            f"{ErrorEnums.ATTRIBUTE_NOT_EQUAL.value} ({expected_2} : {actual_2})"
    ...
    def check_all_attrs_p3(self):
        ...
        assert expected_attr1_val != expected_attr1_val_2, \
            f"{ErrorEnums.ATTRIBUTE_EQUAL.value} ({expected_attr1_val} : {expected_attr1_val_2})"

        assert expected_attr2_val != expected_attr2_val_2, \
            f"{ErrorEnums.ATTRIBUTE_EQUAL.value} ({expected_attr2_val} : {expected_attr2_val_2})"

        assert expected_attr3_val != expected_attr3_val_2, \
            f"{ErrorEnums.ATTRIBUTE_EQUAL.value} ({expected_attr3_val} : {expected_attr3_val_2})"

        assert expected_attr4_val == expected_attr4_val_2, \
            f"{ErrorEnums.ATTRIBUTE_EQUAL.value} ({expected_attr4_val} : {expected_attr4_val_2})"
